...
module domain
       ...
       integer, parameter :: nx_gl = 192 ! Number of grid points in X
       integer, parameter :: ny_gl = 192 ! Number of grid points in Y
...
!  * if 2D case, ny_gl = nsubdomains_y = 16 ;
!  * nsubdomains_x*nsubdomains_y = 16total number of processors
!  * if one processor is used, than  nsubdomains_x = 12nsubdomains_y = 16;

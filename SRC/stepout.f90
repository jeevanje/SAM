...
if(mod(nstep,nstat).eq.0) then
  if(masterproc) print *,'Writing statistics:nstatsteps=',nstatsteps
...
!print*,'--->',tk(27,1,1)
!print*,'tk->:'
!write(6,'(16f7.2)')((tk(i,1,k),i=16,31),k=nzm,1,-1)
!print*,'p->:'
!write(6,'(16f7.2)')((p(i,1,k),i=16,31),k=nzm,1,-1)
!print*,'u->:'
!write(6,'(16f7.2)')((u(i,1,k),i=16,31),k=nzm,1,-1)
!print*,'v->:'
!write(6,'(16f7.2)')((v(i,1,k),i=16,31),k=nzm,1,-1)
!print*,'w->:'
!write(6,'(16f7.2)')((w(i,1,k),i=16,31),k=nzm,1,-1)
!print*,'qcl:'
...
!print*,'t->:'
!write(6,'(16f7.2)')((t(i,1,k),i=16,31),k=nzm,1,-1)
!print*,'tabs->:'
...
!--------------------------------------------------------
 ...
 if(masterproc) then
   ...
   996 format(' disbalance (mm)    ',F16.11)
   print*,' disbalance (rel error):', &

...
real function esatw(t) ! Saturation vapor pressure
implicit none
...
real function qsatw(t,p) ! Saturation mixing ratio
implicit none
real t	! temperature (K)
real p	! pressure    (mb)
real esat,esatw
...
real function dtesatw(t) ! temp-derivative of sat vap press
implicit none
real t	! temperature (K)
real a0,a1,a2,a3,a4,a5,a6,a7,a8 
data a0,a1,a2,a3,a4,a5,a6,a7,a8 /&
...
real function dtqsatw(t,p) ! temp-derivative of sat mix ratio
implicit none
real t	! temperature (K)
real p	! pressure    (mb)
real dtesatw

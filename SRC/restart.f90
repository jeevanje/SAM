	...
	call task_barrier()
        ...
        write(65)  &
         u, v, w, t, tke, tk, tkh, p, qv, qcl, qci, qpl, qpi, dudt, dvdt, dwdt, &
         tracer, micro_field, z, pres, prespot, presi, rho, rhow, bet, sstxy, & 
         rank, nx, ny, nz, irecc
        close(65)
        if(masterproc) then
           write(66) version, &
            ...
            dosmagor, doscalar, dowallx, dowally, doperpetual, doseasons, &
            ...
            docoriolisz, doradlon, doradlat, &
            ntracers, nmicro_fields
            close(66)
        end if
        ...
        use movies, only: irecc
        implicit none
        integer  nx1, ny1, nz1, rank1, ntr, nmic
        character(100) case1,caseid1
        character(5) version1

        read(65)  &
         u, v, w, t, tke, tk, tkh, p, qv, qcl, qci, qpl, qpi, dudt, dvdt, dwdt, &
         tracer, micro_field, z, pres, prespot, presi, rho, rhow, bet, sstxy, &
         rank1, nx1, ny1, nz1, irecc
        close(65)
        read(66) version1, &
            at, bt, ct, dt, dtn, dt3, time, dx, dy, dz, doconstdz, &
            ...
            cem, les, ocean, land, sfc_flx_fxd, sfc_tau_fxd, &
            nrad, nxco2, latitude0, longitude0, dofplane, &
            docoriolisz, doradlon, doradlat, ntr, nmic
        close(66)
        ...
        if(nmic.ne.nmicro_fields) then
           ...
           print*,'nmicro_fields=',nmicro_fields,'   ntracers(in file)=',nmic
           print*,'Exiting...'
        end if
